...
function page() {
  return (
    <div className='login-page isolate flex items-center'>
      <div className=' max-w-5xl flex flex-col  w-full mx-auto h-[calc(min(85vh,700px))]'>
        ...
        <div className='flex grow'>
          <div className='basis-[60%] my-auto rounded-l-md overflow-hidden max-h-[90%] h-full isolate relative '>
            ...
            <div className="absolute z-10 inset-0  bg-gradient-to-tr from-black via-orange-500 to-black opacity-[0.7]"></div>
          ...
          <div className=' basis-[40%] h-full  items-center justify-center bg-white rounded-md '>
