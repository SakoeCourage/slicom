...
function newidentificationtypeform() {
    return (
        <form className='h-full '>
            <nav className="grid grid-cols-1 h-full  gap-3">
                <div className='p-5 flex flex-col gap-3'>
                    <Input required label='Identification Type Name' className=' my-auto' placeholder='Enter Identification Type Name' />
                </div>
...
export default newidentificationtypeform