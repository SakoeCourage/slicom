        ...
        <div className=' '>
            ...
            <div className='grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3'>
                <Statscard
                    ...
                    icon={<svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 48 48"><defs><mask id="ipSProtect0"><g fill="none" strokeLinejoin="round" strokeWidth="4"><path fill="#fff" stroke="#fff" d="M6 9.256L24.009 4L42 9.256v10.778A26.316 26.316 0 0 1 24.003 45A26.32 26.32 0 0 1 6 20.029z" /><path stroke="#000" strokeLinecap="round" d="m15 23l7 7l12-12" /></g></mask></defs><path fill="currentColor" d="M0 0h48v48H0z" mask="url(#ipSProtect0)" /></svg>}
