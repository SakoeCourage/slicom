...
export default function Sidebaritem(props: params) {
  ...
  return (
    <div
      ...
      <ul ref={listitems} className={`${isIncurrentpathname && "rounded-b-md"} overflow-hidden h-0  transition-all add-customer-bezier duration-300 bg-gray-500/10  list-none px-1 py-[0.03rem]  `}>
