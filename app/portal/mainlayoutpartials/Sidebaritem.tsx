        ...
        {props.links.map((link, i) =>
          <li key={i} className=" list-none">
            <Link
              ...
              className={
                classNames({
                  'flex item-center gap-1  hover:text-orange-500 py-1 pl-8 w-full text-sm font-semibold  ': true,
                  'text-orange-600  rounded-md w-full': pathname.startsWith(link.link),
                  '!text-gray-600/95': !pathname.startsWith(link.link)
                })}>
